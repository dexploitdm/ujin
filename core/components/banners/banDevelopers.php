...
add_action( 'init', 'true_register_post_type_init_bandev' ); // Использовать функцию только внутри хука init

function true_register_post_type_init_bandev() {
    $labels = array(
        'name' => 'Застройщики - элементы баннера',
        ...
        'menu_name' => 'Заст. баннер' // ссылка в меню в админке
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
    ...
    register_post_type('bandev', $args);
}
