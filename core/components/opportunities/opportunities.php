...
add_action( 'init', 'true_register_post_type_init_opportunities' ); // Использовать функцию только внутри хука init

function true_register_post_type_init_opportunities() {
    $labels = array(
        'name' => 'Возможности',
        ...
        'menu_name' => 'Возможности Ujin' // ссылка в меню в админке
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
