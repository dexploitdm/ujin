                    ...
                    <div class="solutions-flex swiper-wrapper">
                        <div class="solutions-flex-item swiper-slide card12">
                            ...
                            <div class="solutions-block">
                                ...
                                <div class="solutions-block-desc">
									...
									<li>Учет потребляемых ресурсов</li>
									<li>Маркетплейс</li>
									<li>Чаты и уведомления</li>
                                    </ul>
                                </div>
                                <div class="btn-link">
                                    <a href="<?php echo get_site_url(); ?>/property-developers/">Подробнее</a>
                                </div>
                            </div>
                        </div>
                        <div class="solutions-flex-item swiper-slide card13">
                            ...
                            <div class="solutions-block">
                                ...
                                <div class="solutions-block-desc">
									...
									<li>Мониторинг и учет потребляемых ресурсов</li>
									<li>Программа лояльности</li>
                                    </ul>
                                </div>
                                <div class="btn-link">
                                    <a href="<?php echo get_site_url(); ?>/hotels/">Подробнее</a>
                                </div>
                            </div>
                        </div>
                        <div class="solutions-flex-item swiper-slide card14">
                            ...
                            <div class="solutions-block">
                                ...
                                <div class="btn-link">
                                    <a href="<?php echo get_site_url(); ?>/communal-services/">Подробнее</a>
                                </div>
                            </div>
                        </div>
                    </div>
